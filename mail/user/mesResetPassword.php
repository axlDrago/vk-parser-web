                        ...
                        <table width="100%" border="0" bgcolor="#474544" cellspacing="0" cellpadding="0" id="header">
                            <tr>
                                <td valign="top" class="header_content">
                                    <h1 style="color: #F4F4F4; font-size: 24px; text-align: center;">Сброс пароля</h1>
                                </td>
                            </tr>
                        </table>
                        <!-- // END #header -->
                ...
                <tr>
                    <td align="center" valign="top" class="body_info_content">
                        <table width="100%" border="0" cellspacing="0" cellpadding="20">
                            <tr>
                                <td valign="top">
                                    <h2 style="color: #474544; font-size: 20px; text-align: center;">Ссылка для восстановления пароля:</h2>
                                    <p style="color: #666666; font-size: 14px; line-height: 22px; text-align: left;"><a href="https://parser-new.ru/site/reset-password?token=<?=$token ?>">
                                            https://parser-new.ru/site/reset-password?token=<?=$token ?></a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td align="center" valign="top" class="body_item_content">
                        <table width="100%" border="0" cellspacing="0" cellpadding="20">
                            <tr>
                                <td align="center" valign="top">
                                    <h2 style="color: #474544; font-size: 20px; text-align: center;">Если Вы не запрашивали сброс пароля, проигнорируйте это письмо.</h2>
                                </td>
                            </tr>
